    ...
    <div>
      <div className="container-fluid row d-block">
        ...
        <div className="container col mb-4">
          <form class="container-fluid d-flex m-auto gap-2 justify-content-center">
            <button
              class="btn rounded-5 pp_btn1  p-0 m-0 fw-semibold"
              type="button"
            >
              Paylaş
            </button>
            <button
              class="btn rounded-5 pp_btn2  p-0 m-0 fw-semibold"
              type="button"
            >
              Profili düzenle
            </button>
        ...
        <div className="container col">
          <form class="container-fluid d-flex m-auto gap-2 justify-content-center">
            <button class="btn rounded-3 pp_btn3  fw-semibold" type="button" onClick={basla}>
              Oluşturuldu
            </button>
            <button class="btn rounded-3 pp_btn4  fw-semibold" type="button" onClick={bitir}>
              Kaydedildi
            </button>
          </form>
        </div>
        <div className="container col mt-4" id="pp_olustur">
          ...
          <button
            class="btn rounded-5 text-light pp_btn5 fw-semibold d-flex m-auto mt-4 p-2"
            type="button"
          >
            Fikir Pini oluştur
          </button>
        ...
        <div className="container col" id="pp_kaydet">
          <div className="container">
            <div className="container-fluid d-flex justify-content-between">
              <button
                class="btn rounded-5 text-dark d-flex pp_btntwn"
                type="button"
              >
                <i class="fa-solid fa-sliders fa-xl m-auto"></i>
              </button>
              <button
                class="btn rounded-5 text-dark fw-semibold d-flex pp_btntwn"
                type="button"
              >
                <i class="fa-solid fa-plus fa-xl m-auto"></i>
              </button>
            </div>
          </div>
          <span className="align-middle d-flex justify-content-center mb-1">
          ...
          <form class="container-fluid d-flex m-auto justify-content-center">
            <button
              class="btn rounded-5 pp_btn6  p-0 m-0 fw-semibold"
              type="button"
            >
              Fikir bul
            </button>
